...
namespace EComm_Project.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            //Add Company and Roles DrownDownList
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            Input = new InputModel()
            {
                ...
                //Show all the roles to the admin accept's Individual 
                RoleList = _roleManager.Roles.Where(r => r.Name != SD.Role_Individual).Select(rl =>new SelectListItem()
                {
                    Text = rl.Name,
                    Value = rl.Name
                })
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    ////Add First user as an admin user 
                    //await _userManager.AddToRoleAsync(user, SD.Role_Admin);

                    //To assign roles to the users-Individual,Employee,Company
